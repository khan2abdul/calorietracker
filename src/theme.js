export const iOSBlurLight = "backdrop-blur-xl bg-white/80 border border-white/20 shadow-sm";
export const iOSBlurDark = "backdrop-blur-xl bg-[#1C1C1E]/90 border-t border-white/10 shadow-[0_-10px_40px_-15px_rgba(255,255,255,0.05)]";
export const iOSBlurWooden = "backdrop-blur-xl bg-[#EAD8B1]/90 border-t border-[#8B4513]/20 shadow-sm";
